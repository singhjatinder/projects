...
(async() => {
	...
	let product1 = new Product({
		name: 'Lenovo ThinkPad T580 15.6" 20L9001',
		description: 'A vivid 15-in display lets you see everything and still be agile Include a 13.8-hour battery life, plenty of ports, and convenient side docking Number pad on keyboard Enhanced security built in for peace of mind.',
		price: '1624.95',
		quantity: '30'
	}); 
